export const GovernanceV3EthereumGovernanceABI = [
  {
    inputs: [
      {
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "cancellationFee", type: "uint256" },
          {
            components: [
              { internalType: "uint256", name: "chain", type: "uint256" },
              {
  ...
  },
  {
    ...
    outputs: [
      { internalType: "enum IGovernanceCore.State", name: "", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint24", name: "votingDuration", type: "uint24" },
          { internalType: "uint56", name: "yesThreshold", type: "uint56" },
          { internalType: "uint56", name: "yesNoDifferential", type: "uint56" },
          {
            internalType: "uint56",
            name: "minPropositionPower",
            type: "uint56",
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: "uint24", name: "votingDuration", type: "uint24" },
          { internalType: "uint256", name: "yesThreshold", type: "uint256" },
          {
            internalType: "uint256",
            name: "yesNoDifferential",
            type: "uint256",
